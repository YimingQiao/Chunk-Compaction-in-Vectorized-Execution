...
const string strategy_name = "full_compact";
#elif defined(flag_binary_compact)
using Compactor = BinaryCompactor;
const string strategy_name = "binary_compact";
#elif defined(flag_dynamic_compact)
using Compactor = DynamicCompactor;
const string strategy_name = "dynamic_compact";
#else
using Compactor = NaiveCompactor;
const string strategy_name = "no_compact";
#endif
